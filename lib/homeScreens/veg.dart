...
class _VegScreenState extends State<VegScreen> {
                    ...
                    ExpansionTile(
                      title: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Veg gravy, Salad with Rice/Bread & Roti',
                    ...
                    ExpansionTile(
                      title: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Rice & chawal/Bread & Roti, Dry Veg, veg Gravy, Dal, Salad, Pickle & Aachar',
                            style: TextStyle(fontSize: 14.0),
                          ),
                        ],
                      ),
                    ...
                    ExpansionTile(
                      title: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Rice, Bread & Roti, Dry Veg, Gravy Veg, Dal, Salad, sweets & dessert, Pickle & Aachar',
                            style: TextStyle(fontSize: 14.0),
                          ),
                        ],
                      ),
  ...
  Future<void> _miniPlanChart() async {
    DocumentSnapshot document =
        await FirebaseFirestore.instance.collection('veg').doc('mini').get();
  ...
  Future<void> _classicPlanChart() async {
    DocumentSnapshot document =
        await FirebaseFirestore.instance.collection('veg').doc('classic').get();
    List<String> bread = List.from(document['Bread']);
    List<String> rice = List.from(document['Rice']);
    List<String> vegGravy = List.from(document['vegGravy']);
    List<String> dal = List.from(document['dal']);
    List<String> vegDry = List.from(document['vegDry']);
...
/*    print('bread: ${bread}');
  ...
  Future<void> _deluxePlanChart() async {
    DocumentSnapshot document =
        await FirebaseFirestore.instance.collection('veg').doc('deluxe').get();
    List<String> bread = List.from(document['bread']);
    List<String> rice = List.from(document['rice']);
    List<String> vegGravy = List.from(document['vegGravy']);
    List<String> dal = List.from(document['dal']);
